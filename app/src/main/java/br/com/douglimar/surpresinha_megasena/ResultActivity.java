...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdView adView = findViewById(R.id.adViewResult2);
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.loadAd(adRequest);

        AppBarLayout appBarLayout = findViewById(R.id.app_bar);
        tvResult = findViewById(R.id.tvResult2);
        CoordinatorLayout linearResult = findViewById(R.id.linearResult3);
        ...
        Snackbar.make(findViewById(R.id.linearResult3), R.string.tip_generateNewBets, Snackbar.LENGTH_LONG)
        ...
        FloatingActionButton fabShare = findViewById(R.id.fabResult2);
