package br.com.douglimar.surpresinhamega;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.mega2);
//        setSupportActionBar(toolbar);
        ...
        linearResult.setBackgroundResource(surpresinha.getBackgroundColors("MEGA-SENA")[0]);
        appBarLayout.setBackgroundResource(surpresinha.getBackgroundColors("MEGA-SENA")[1]);
